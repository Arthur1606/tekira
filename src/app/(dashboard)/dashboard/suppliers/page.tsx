      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-zinc-100 tracking-tight flex items-center gap-3">
            <Users className="w-8 h-8 text-indigo-500" /> Proveedores
          </h1>
        ...
        {suppliers.length === 0 ? (
          <div className="col-span-full">
            <Card className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <h3 className="text-lg font-bold text-zinc-100">No hay proveedores</h3>
          ...
          suppliers.map((supplier) => (
            <Card key={supplier.id} className="group hover:border-indigo-500/30 transition-all duration-300">
              <div className="flex justify-between items-start mb-4">
                <h3 className="text-xl font-bold text-zinc-100 group-hover:text-indigo-400 transition-colors">{supplier.name}</h3>
                {supplier.category && (
