...
export default function AuthConfirmPage() {
  return (
    <div className="min-h-screen bg-[#09090B] flex flex-col items-center justify-center p-4 font-sans text-zinc-100 animate-in fade-in duration-500">
      ...
      <div className="w-full max-w-md bg-zinc-950/80 border border-zinc-800/80 rounded-2xl p-8 shadow-2xl backdrop-blur-2xl text-center space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-zinc-100 tracking-tight">Correo Verificado Correctamente</h1>
        ...
        <div className="pt-4 border-t border-zinc-800">
          <Link href="/dashboard" className="block w-full">
            <Button fullWidth className="py-3.5 text-sm font-bold shadow-xl shadow-indigo-600/20 flex items-center justify-center gap-2">
