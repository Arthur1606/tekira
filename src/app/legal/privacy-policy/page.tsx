        ...
        <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-6 sm:p-10 space-y-8 text-sm text-zinc-300 leading-relaxed shadow-2xl">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-indigo-400" /> 1. Responsable del Tratamiento de Datos
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-indigo-400" /> 2. Datos Personales Recopilados
            </h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-indigo-400" /> 3. Propiedad de la Información Comercial
            </h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-indigo-400" /> 4. Finalidad del Tratamiento de Datos
            </h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-indigo-400" /> 5. Derechos del Titular (Habeas Data)
            </h2>
            <p>
