        ...
        <div className="bg-[#0E1310] border border-[#232C26] rounded-3xl p-6 sm:p-10 space-y-8 text-sm text-zinc-300 leading-relaxed shadow-2xl">
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[#F5F5F0] flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-[#8EA653]" /> 1. Aceptación de los Términos
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[#F5F5F0] flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-[#8EA653]" /> 2. Propiedad Intelectual Exclusiva
            </h2>
            <div className="p-4 bg-[#141A16] border border-[#232C26] rounded-2xl text-xs space-y-2 text-zinc-300">
              <p className="font-bold text-[#F5F5F0]">Derechos Reservados © 2026 TEKIRA:</p>
              <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[#F5F5F0] flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-[#8EA653]" /> 3. Uso Permitido y Responsabilidad de Credenciales
            </h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[#F5F5F0] flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-[#8EA653]" /> 4. Roles y Permisos en el Comercio
            </h2>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-[#F5F5F0] flex items-center gap-2">
              <CheckCircle className="w-4 h-4 text-[#8EA653]" /> 5. Suspensión de Cuentas y Seguridad
            </h2>
            <p>
