...
export default async function StandaloneSetupMfaPage({
  ...
  return (
    <div className="min-h-screen w-full bg-[#0B0F0D] font-sans flex items-center justify-center p-4 sm:p-6 lg:p-10 xl:p-12 relative overflow-x-hidden">
      
      {/* Background Glow Effects (Stripe / Vercel style) */}
      <div className="absolute top-[-25%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#556B2F]/15 blur-[160px] pointer-events-none"></div>
      <div className="absolute bottom-[-25%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[#556B2F]/15 blur-[160px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch relative z-10 my-auto">
        ...
        <div className="lg:col-span-7 bg-[#141A16] backdrop-blur-2xl rounded-3xl shadow-2xl border border-zinc-800/90 p-6 sm:p-10 lg:p-12 flex flex-col justify-between space-y-8 min-w-0">
          
          {/* Header */}
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#556B2F] rounded-2xl flex items-center justify-center shadow-lg shadow-[#556B2F]/20 shrink-0">
                <span className="text-white font-black text-2xl leading-none">T</span>
              </div>
              <div>
                <span className="font-black text-2xl text-[#F5F5F0] tracking-tight block">TEKIRA</span>
                <span className="text-[10px] font-mono text-[#8EA653] uppercase tracking-widest block font-bold">Enterprise Security</span>
              </div>
            </div>

            <div className="pt-3 border-t border-[#232C26]">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-[#F5F5F0] tracking-tight">Activación Obligatoria de 2FA</h1>
          ...
          <div className="space-y-8 w-full">
            ...
            <div className="bg-[#0E1310] p-6 sm:p-8 rounded-3xl border border-zinc-800/90 space-y-6 shadow-inner w-full">
              <div className="flex items-center justify-between border-b border-[#232C26] pb-4">
                <span className="text-xs sm:text-sm font-bold uppercase tracking-wider text-[#8EA653] flex items-center gap-2">
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-8 w-full">
                ...
                <div className="space-y-4 flex-1 min-w-0 pt-2">
                  <h3 className="text-xs sm:text-sm font-bold text-zinc-200 uppercase tracking-wider flex items-center gap-2">
                    <Smartphone className="w-4 h-4 text-[#8EA653]" /> Instrucciones de Vinculación
                  </h3>

                  <ol className="space-y-3 text-xs sm:text-sm text-zinc-300 font-medium">
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#556B2F]/20 text-[#8EA653] flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">1</div>
                    ...
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#556B2F]/20 text-[#8EA653] flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">2</div>
                      <span>Selecciona la opción <strong>"Escanear código QR"</strong> y enfoca la pantalla.</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-6 h-6 rounded-full bg-[#556B2F]/20 text-[#8EA653] flex items-center justify-center text-xs font-bold shrink-0 mt-0.5">3</div>
            ...
            <div className="bg-[#0E1310] p-6 sm:p-8 rounded-3xl border border-zinc-800/90 space-y-6 shadow-inner w-full">
              ...
              <form action={enableMfaMandatoryAction} className="space-y-5 w-full">
                ...
                <SubmitButton fullWidth className="py-4 text-sm sm:text-base font-bold bg-[#556B2F] hover:bg-[#7C9A42] text-[#F5F5F0] shadow-xl shadow-[#556B2F]/20">
        ...
        <div className="hidden lg:flex lg:col-span-5 flex-col justify-between p-8 sm:p-10 lg:p-12 bg-[#0E1310] backdrop-blur-2xl rounded-3xl border border-zinc-800/90 shadow-2xl space-y-8 min-w-0">
          
          <div className="space-y-6">
            <div className="w-16 h-16 bg-[#556B2F]/10 rounded-2xl flex items-center justify-center border border-[#7C9A42]/30 shadow-inner">
              <ShieldCheck className="w-8 h-8 text-[#8EA653]" />
            </div>

            <div>
              <span className="text-xs font-mono font-bold text-[#8EA653] uppercase tracking-widest block mb-1">Protección Empresarial</span>
              <h2 className="text-2xl sm:text-3xl font-black text-[#F5F5F0] tracking-tight leading-snug">Seguridad de Nivel Enterprise</h2>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="flex items-start gap-4 p-4 bg-[#141A16] rounded-2xl border border-zinc-800/70 hover:border-[#2B372F] transition-colors">
                <div className="p-2.5 bg-[#556B2F]/10 rounded-xl text-[#8EA653] shrink-0">
              ...
              <div className="flex items-start gap-4 p-4 bg-[#141A16] rounded-2xl border border-zinc-800/70 hover:border-[#2B372F] transition-colors">
                <div className="p-2.5 bg-[#556B2F]/15 rounded-xl text-[#8EA653] shrink-0">
          ...
          <div className="p-5 bg-gradient-to-br from-[#556B2F]/10 to-[#556B2F]/10 rounded-2xl border border-[#7C9A42]/30 text-xs sm:text-sm text-[#8EA653] font-medium leading-relaxed">
