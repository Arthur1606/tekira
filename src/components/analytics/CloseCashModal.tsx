      ...
      <div className="relative w-full max-w-lg bg-zinc-950 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden p-6 sm:p-8 space-y-6 animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between border-b border-zinc-800 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl font-bold text-zinc-100">Cierre de Caja Operativa</h3>
        ...
        <div className="bg-zinc-900/60 p-4 rounded-xl border border-zinc-800/80 space-y-3">
          <span className="text-[10px] uppercase font-bold text-zinc-500 tracking-wider block">Resumen de la Jornada</span>
          
          <div className="grid grid-cols-2 gap-3 text-xs">
            <div className="flex items-center justify-between p-2.5 bg-zinc-950/60 rounded-lg border border-zinc-800/50">
            ...
            <div className="flex items-center justify-between p-2.5 bg-indigo-950/40 rounded-lg border border-indigo-500/30">
              <span className="text-indigo-300 font-bold">Caja Esperada</span>
              <span className="font-black text-indigo-200">{formatCurrency(expectedAmount)}</span>
            </div>
          </div>
        </div>
        ...
        <form action={closeCashRegister} className="space-y-6">
          ...
          <div className="pt-4 border-t border-zinc-800 flex justify-end gap-3">
            ...
            <SubmitButton className="px-6 py-2.5 text-sm font-bold bg-amber-600 hover:bg-amber-500 text-white shadow-lg">
  ...
  return (
    <>
      <Button
        ...
        className="bg-zinc-800/90 hover:bg-zinc-700 text-zinc-100 border border-zinc-700/80 shadow-sm text-xs font-bold px-3 py-1.5 h-auto rounded-lg flex items-center gap-1.5"
      >
