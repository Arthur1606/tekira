...
export function StatusCard({ title, value, subtitle, status = 'neutral', icon: Icon }: StatusCardProps) {
  ...
  return (
    <div className="flex items-center justify-between p-3 sm:p-4 bg-zinc-950/40 border border-white/[0.03] rounded-xl hover:bg-zinc-900/60 hover:border-white/[0.05] transition-all group">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="flex items-baseline gap-2 mt-0.5">
            <h3 className="text-lg font-black text-zinc-100 leading-none">{value}</h3>
          </div>
        </div>
      </div>
